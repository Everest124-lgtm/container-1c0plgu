...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1c0plgu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1c0plgu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Everest124-lgtm/container-1c0plgu.git
cd container-1c0plgu
```
...
```
docker attach container-1c0plgu
```
